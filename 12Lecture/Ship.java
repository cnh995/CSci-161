...
public class Ship
{
    ...
    //compare current cargo tonnage, see who has more cargo on board
    public double compareTo(Ship other)
    {
	return getCurrentCargoTonnage() - other.getCurrentCargoTonnage();
    }
