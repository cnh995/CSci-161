public class CDLL
{
	...
	if(head == null)
		...
		while(curr.getNext() != head) //While current node doesn't point to head, move on
		    {
			curr = curr.getNext(); //When the current node points to head, we know we are at the end (if single linked list)
		    }
