...
public class Port
{
    ...
    public Port(String inName, double inOutbound)
    {
	setName(inName);
	setOutbound(inOutbound);
    }

    public Port(String inName)
    {
	Random rng = new Random();
	double randOutCargo = rng.nextDouble();
	double actualOut = randOutCargo * 10000;

	setName(inName);
	setOutbound(actualOut);
    }

    public Port(double inOutbound)
    {
	setOutbound(inOutbound);
    }
