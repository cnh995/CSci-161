    ...
    public static void main(String[] args) throws FileNotFoundException
    {
         ...
         for (Port p : myPorts)
         {
              for (Ship s : myShips)
              {
                   ...
                   ArrayList<Cargo> tempList = p.getLocal();
                   for (Cargo temp : tempList)
                   {
                        System.out.println("\tLocal Cargo:");
                        System.out.println(temp);
                   }
                   tempList = p.getOutbound();
                   for (Cargo temp : tempList)
                   {
                        System.out.println("\tOutbound Cargo:");
                        System.out.println(temp);
                   }
                   
                   System.out.println("\tTotal Outbound:\t" + p.getOutboundTonnage());
                   System.out.println("\tTotal Local:\t" + p.getLocalTonnage());
                   System.out.println("--------------------\n");
                   
                   System.out.println("Ship: " + s.getName());
                   tempList = s.getCurrentCargo();
                   for (Cargo temp : tempList)
                   {
                        System.out.println("\tLocal Cargo:");
                        System.out.println(temp);
                   ...
                   System.out.println("\tTotal Cargo:\t" + s.getCurrentCargoTonnage());
                   System.out.println("\tMax Cargo:\t" + s.getMax());
                   System.out.println("--------------------\n");
              }
         ...
         for (Ship s : myShips)
         {
              ...
              //Check data
              System.out.println("Port: " + myPorts.get(0).getName());
              ArrayList<Cargo> tempList = myPorts.get(0).getLocal();
              for (Cargo temp : tempList)
              {
                   System.out.println("\tLocal Cargo:");
                   System.out.println(temp);
              ...
              tempList = myPorts.get(0).getOutbound();
              for (Cargo temp : tempList)
              {
                   System.out.println("\tOutbound Cargo:");
                   System.out.println(temp);
              ...
              System.out.println("\tTotal Outbound:\t" + myPorts.get(0).getOutboundTonnage());
              System.out.println("\tTotal Local:\t" + myPorts.get(0).getLocalTonnage());
              System.out.println("--------------------\n");
