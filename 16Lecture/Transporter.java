import java.util.*;
public abstract class Transporter implements Traveller //add more with comma ex Traveller, NextThing
{
    private String name = "";
    ...
    public String travel()
    {
         ...
         {
              setDistance(traveled);
              output = "The Transporter: " + getName() + " has arrived at its destination";
         }
         return output;
    }
